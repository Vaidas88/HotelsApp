    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CleanerRoom", x => new { x.CleanersId, x.RoomsId });
                    table.ForeignKey(
                        name: "FK_CleanerRoom_Cleaners_CleanersId",
                        column: x => x.CleanersId,
                        principalTable: "Cleaners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CleanerRoom_Rooms_RoomsId",
                        column: x => x.RoomsId,
